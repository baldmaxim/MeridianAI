    ...
    <div style={styles.card}>
      ...
      <div style={styles.toggles}>
        ...
        <Toggle
          ...
          description={value === 'deepgram' || value === 'speechmatics' ? 'Diarization — различать «Вы» и «Клиент»' : 'Только для Deepgram / Speechmatics'}
          disabled={value !== 'deepgram' && value !== 'speechmatics'}
        />
        <Toggle
